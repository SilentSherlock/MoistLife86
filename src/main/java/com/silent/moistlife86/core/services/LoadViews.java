package com.silent.moistlife86.core.services;

import com.silent.moistlife86.core.Context;
import com.silent.moistlife86.core.interfaces.Loader;
import com.silent.moistlife86.core.view.*;
...
public class LoadViews extends Task<View> {
    ...
    public LoadViews(Context context, Loader loader) {
        ...
        InputStream inputStream = getClass().getResourceAsStream("/com.silent.moistlife86/views.yml");
    ...
    private void loadView(ViewComposer view) {
        ...
        String path = "/com.silent.moistlife86/views";
